...
```gradle
dependencies {
    implementation 'com.github.apiverve:randompun-api:1.1.12'
}
```
...
```java
import com.apiverve.randompun.RandomPunAPIClient;
import com.apiverve.randompun.APIResponse;
import com.apiverve.randompun.APIException;

// Initialize the client
RandomPunAPIClient client = new RandomPunAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/randompun](https://docs.apiverve.com/ref/randompun)
...
- **Documentation:** [https://docs.apiverve.com/ref/randompun](https://docs.apiverve.com/ref/randompun)
- **Issues:** [GitHub Issues](https://github.com/apiverve/randompun-api/issues)
