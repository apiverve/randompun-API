/*
 * Random Pun API - Basic Usage Example
 *
 * This example demonstrates the basic usage of the Random Pun API.
 * API Documentation: https://docs.apiverve.com/ref/randompun
 */
...
{
    class RandomPunExample
    {
        private static readonly string API_KEY = Environment.GetEnvironmentVariable("APIVERVE_API_KEY") ?? "YOUR_API_KEY_HERE";
        private static readonly string API_URL = "https://api.apiverve.com/v1/randompun";

        /// <summary>
        /// Make a GET request to the Random Pun API
        /// </summary>
        static async Task<JsonDocument> CallRandomPunAPI()
        {
            try
            {
        ...
        {
            Console.WriteLine("📤 Calling Random Pun API...\n");

            var result = await CallRandomPunAPI();
